...
- ![](new.png){.pull-left width=2.5%}[PsychoPy例1-1](demo.zip)![](zip.jpg){.pull-left width=2.5%}
__３つの刺激から１つをマウスで選択 & 選ばなかった刺激は半透明グレー__: 
簡単なデモと説明のパワーポイントファイルがあります。必ずzipファイルを展開してからお試しください。PsychoPy3(v3.2.4)で作成，2020.07.29

- ![](new.png){.pull-left width=2.5%}[PsychoPy例1-2](Rock-paper-scissors.zip)![](zip.jpg){.pull-left width=2.5%}
