...
#### PsychoPy ![](new.png){.pull-left width=2.5%}
...
* [PsychoPy：３つの刺激から１つをマウスで選択 & 選ばなかった刺激は半透明グレー](demo.zip)![](zip.jpg){.pull-left width=2.5%}:zipファイルの中に簡単なデモと説明のパワーポイントファイルがあります。PsychoPy3(v3.2.4)使用，2020.07.29
